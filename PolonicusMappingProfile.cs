        ...
        public PolonicusMappingProfile()
        {
            ...
            CreateMap<CreateOutpostDto, Outpost>()
                .ForMember(o => o.Address,
                    ...
                    { City = dto.City, Street = dto.Street, PostalCode = dto.PostalCode , Coord_latitude=dto.Coord_latitude, Coord_longtiude=dto.Coord_longtiude})); 


            CreateMap<Chronicle, ChronicleDto>();
            CreateMap<CreateChronicleDto, Chronicle>()
                .ForMember(
                    m => m.PublicationDate, p => p.MapFrom(s => DateTime.Parse(s.PublicationDate,CultureInfo.InvariantCulture))
                );
